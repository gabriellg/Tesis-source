...
class CGraphicsPoints: public IGraphics
{
    public:

        CGraphicsPoints();
        virtual ~CGraphicsPoints();

        class CArrPoint3d *getPoints3D(void) const;
    ...
    private:
        ...
        struct prv_dataPrivateGraphicsPoints_t *m_dataPrivate;
};
