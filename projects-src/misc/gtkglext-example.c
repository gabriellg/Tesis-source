...
static void i_dibuja(gboolean rotate)
{
	glPushMatrix();
...
static void i_dibuja_en_superficie(GdkGLContext *glcontext, GdkGLDrawable *gldrawable, gboolean borrado)
{
...
static gboolean expose (GtkWidget *da, GdkEventExpose *event, gpointer user_data)
{
	...
	i_dibuja_en_superficie(glcontext, gldrawable, true);
	// g_print (" :: expose\n");
...
configure (GtkWidget *da, GdkEventConfigure *event, gpointer user_data)
{
	...
	glLoadIdentity();
	glViewport (0, 0, da->allocation.width / 2., da->allocation.height);
